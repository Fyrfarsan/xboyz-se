...
<html lang="sv-SE"><head>';
    ...
    echo '
    <meta charset="UTF-8">
	<meta content="text/html; charset=', $context['character_set'], '" />
	...
	echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/assets/css/xboyz2.css?fin20" />';
			...
			<div class="container hidden-phone">
				<div id="navbar" class="navbar">
					<div class="navbar-transparent">
						<div class="container">
							<a href="#" class="brand"><img src="<?php echo $settings['theme_url'] ?>/assets/img/xbz_logo.png"  alt="XBOYZ.SE"></a>
							<img id="avatars" src="<?php echo $settings['theme_url'] ?>/assets/img/xbz_avatars.png" />
