    ...
    foreach ($context['categories'] as $category) {
        ...
        foreach ($category['boards'] as $board) {
            ...
            if ($board['new'] || $board['children_new'])
                echo '
						<img src="', $settings['images_url'], '/xbz_forum.png" alt="', $txt['new_posts'],
                    '" title="', $txt['new_posts'], '" border="0" />';
            else
                echo '<img src="', $settings['images_url'], '/xbz_forum.png" alt="', $txt['old_posts'],
                    '" title="', $txt['old_posts'], '" />';
            ...
            echo '							
					...
					<div class="span2 visible-desktop">
						', $board['topics'], ' ämnen ', $board['posts'], ' inlägg
					</div>
					<div class="span4 hidden-phone">';
