...
<?php
    ...
    */
    ...
    <html><head>';
        ...
        echo '<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/assets/css/bootstrap.css?fin20" />
        <link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/assets/css/bootstrap-responsive.css?fin20" />';
    
    
        echo '
        <link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/assets/css/xboyz.css?fin20" />';
        //google fonts
        ...
        //if in Admin mode add default-theme CSS
        if (!empty($_REQUEST['action']) && $_REQUEST['action'] == 'admin' || $_REQUEST['action']=='moderate')
            echo '
        <link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/index', $context['theme_variant'], '.css?fin20" />';
    
        // Here comes the JavaScript bits!
    
        //Do we need a html5shim?'
        echo '
                ...
                <div class="navbar-transparent">
                    ...
                    <div class="tool-collapse">
                        <ul class="nav nav-pills">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Min Profil <b class="caret"></b></a>
...
<div class="maincontainer">
    <div class="innercontainer">
        <?php
                ...
                // Display user name and time. USE LATER!
                /*echo '
                ...
                echo '
                    <div id="news_section" class="span6', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
                        <form class="pull-right" id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
                ...
                if (!empty($settings['enable_news']))
                    echo '
                        <div id="random_news" class="span6"><h3>', $txt['news'], ':</h3><p>', $context['random_news_line'], '</p></div>';
            ...
            */
            ...
            function template_html_below()
            {
                ...
                echo '<script src="', $settings['theme_url'] ,'/assets/js/bootstrap.js"></script>';
                echo '
            </body></html>';
            }
            ...
            function template_menu()
            {
                ...
                foreach ($context['menu_buttons'] as $act => $button)
                {
                    ...
                    $classes = implode(' ', $classes);
                        ...
                        if (in_array($act, array('profile', 'mlist','pm'))){
                            continue;
                        }
            
                    echo '
                        <li id="button_', $act, '"', !empty($classes) ? ' class="' . $classes . '"' : '','>
                            <a title="', !empty($button['alttitle']) ? $button['alttitle'] : $button['title'], '"' , !empty($button['sub_buttons']) ? 'class="dropdown-toggle" data-toggle="dropdown"' : '', '  href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '>
            ...
            function template_button_strip($button_strip, $direction = 'top', $strip_options = array())
            {
                ...
                echo '
                    <div class="toolbar-collapse', $direction != 'top' ? '_bottom' : '', '"', (empty($buttons) ? ' style="display: none;"' : ''), (!empty($strip_options['id']) ? ' id="' . $strip_options['id'] . '"': ''), '>
                        <ul class="nav nav-pills">',
                            implode('', $buttons), '
                        </ul>
                    </div>';
